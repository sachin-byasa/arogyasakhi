...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                @if (isset($all_villages) && count($all_villages)>0)
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center" style="width: 120px;">
                                        ...
                                        |
                                        <a href="#"
                                            onclick="return deleteconfirm('/admin/villages/delete/{{$village->village_id}}')">
                        ...
                        {{ $all_villages->appends(Request::except('page'))->links() }}

                        Showing {{ $all_villages->firstItem() }} to {{ $all_villages->lastItem() }} of total {{$all_villages->total()}} entries
                    </div>
                </div>
                @else
