            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form action="{{route('villages.update',['village_id' => $village_data->village_id])}}" method="POST" id="villageForm">
                            ...
                            <div class="form-group row">
                                ...
                                placeholder="Enter Name of the State" required value="{{$village_data->village_name}}">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="state" name="state" aria-required="true" required>
                                        ...
                                        @if ($village_data->state_id== $state->state_id ) selected @endif >{{$state->state_name}}</option>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="district" name="district" aria-required="true" required>
                                        ...
                                        @if ($village_data->district_id== $district->district_id ) selected @endif >{{$district->district_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="block" name="block" aria-required="true" required>
                                        ...
                                        @if ($village_data->block_id== $block->block_id ) selected @endif >{{$block->block_name}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('block'))
                                    <span style="display:block" class="invalid-feedback" role="alert">
