            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form action="{{Request::root()}}/admin/districts/update" method="post" id="districtForm">
                            ...
                            <div class="form-group row">
                                ...
                                placeholder="Enter Name of the State" required value="{{$district->district_name}}">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="state" name="state" aria-required="true" required>
                                        ...
                                        @if ($district->state_id == $state->state_id ) selected @endif >{{$state->state_name}}</option>
