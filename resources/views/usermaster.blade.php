...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
            <form class="form-row mt-2 mb-2" method="post" action="{{ route('usermaster.user.list') }}">
                @csrf
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control input-default @error('isactive') is-invalid @enderror" name="isactive" required>
                                            <option @if($userType->isactive == old('isactive')) selected @endif value="1">Active</option>
                                            <option @if($userType->isactive == old('isactive')) selected @endif value="0">Inactive</option>
                                        </select>
                                        @error('isactive')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                @forelse($usermaster as $user)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('usermaster.user.edit', $user->user_id) }}">Edit</td>
                                        <!--  / <a href="{{ route('usermaster.user.edit', $user->user_id) }}">Inactive</a> -->
                                    </tr>
                                @empty
                                    <tr>
