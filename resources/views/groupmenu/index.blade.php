...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
            <form class="form-row mt-4 mb-2" method="post" action="{{ route('group-menu.index') }}">
                @csrf
                ...
                <!-- <div class="col-lg-2 col-md-12 mb-2">
                <input class="form-control input-default @error('limit') is-invalid @enderror" name="limit" placeholder="Limit" value="{{$request->limit}}" required>
                </div> -->
                                        ...
                                        <tbody>
                                            @forelse($menu as $m)
                                                <tr>
                                                    <td>{{$m->menu_name}}</td>
                                                    <td>{{$m->child_name}}</td>
                                                    <td><input type="checkbox" id="group_insert_{{$m->menuchild_id}}" name="group[{{$m->menuchild_id}}]['insert']"></td>
                                                    <td><input type="checkbox" id="group_update_{{$m->menuchild_id}}" name="group[{{$m->menuchild_id}}]['update']"></td>
                                                    <td><input type="checkbox" id="group_delete_{{$m->menuchild_id}}" name="group[{{$m->menuchild_id}}]['delete']"></td>
                                                    <td><input type="checkbox" id="group_view_{{$m->menuchild_id}}" name="group[{{$m->menuchild_id}}]['view']"></td>
                                                    <td><input type="checkbox" id="group_download_{{$m->menuchild_id}}" name="group[{{$m->menuchild_id}}]['download']"></td>
                                                    <td><input type="checkbox" id="group_select_all_{{$m->menuchild_id}}" onclick="toggle({{$m->menuchild_id}})"></td>
                                                </tr>
                                            @empty
                                                <tr>
