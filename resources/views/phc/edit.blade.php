            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form action="{{ route('phc.update', $phc->phc_id) }}" method="post" id="stateForm">
                        @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="phc_name" name="phc_name" value="{{$phc->phc_name}}"
                            ...
                            <label class="col-lg-2 col-form-label" for="block">Block <span class="text-danger">*</span></label>
                                <div class="col-lg-6">
                                    <select class="form-control" id="block" name="block" aria-required="true" required>
                                        ...
                                        @if ($block->block_id == $phc->block_id ) selected @endif >{{$block->block_name}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('block'))
                                    <span style="display:block" class="invalid-feedback" role="alert">
                            ...
                            <label class="col-lg-2 col-form-label" for="status">Status <span class="text-danger">*</span></label>
                                <div class="col-lg-6">
                                    <select class="form-control" id="status" name="status" aria-required="true" required>
                                        ...
                                        <option value="1" @if($phc->isactive == 1 ) selected @endif>Active</option>
                                        <option value="0" @if($phc->isactive == 0 ) selected @endif>Inctive</option>
                                    </select>
